...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@/components/checkbox': itemFile('checkbox/files/checkbox.tsx'),
      '@/components/switch': itemFile('switch/files/switch.tsx'),
      '@/components/radio-group': itemFile('radio-group/files/radio-group.tsx'),
      '@/components/textarea': itemFile('textarea/files/textarea.tsx'),
