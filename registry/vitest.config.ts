...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@/components/button': itemFile('button/files/button.tsx'),
      '@/components/card': itemFile('card/files/card.tsx'),
      '@/components/badge': itemFile('badge/files/badge.tsx'),
      '@/components/input': itemFile('input/files/input.tsx'),
      '@/components/separator': itemFile('separator/files/separator.tsx'),
